...
public class ManagerEnsamblajeMueble {
    ...
    private String seleccionarFechaEnsamblaje = "SELECT * FROM Ensamblaje_Piezas WHERE Fecha_Ensamblaje = ?";
    private String seleccionarMueble = "SELECT * FROM Ensamblaje_Piezas WHERE Mueble = ?";
    private String seleccionarEnsamblador = "SELECT * FROM Ensamblaje_Piezas WHERE Ensamblador = ?";
